...
#        body="Looking for sites"
#    )
siteid="10056207 272300"
...
while current_date <= end_date:
    ...
    command = f"python camping2.py --start-date {start_date.strftime('%Y-%m-%d')} --end-date \
    {end_date.strftime('%Y-%m-%d')} --show-campsite-info --parks "+ siteid + " > output.txt"
...
lastime = 0
interval_time = 300/len(run_commands);
printflag = 0
