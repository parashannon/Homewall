...
# ***************************************
# Change start and end dates and park string per the above
start_date="2024-12-9";
end_date="2024-12-10";
park_string='232472 272300 10056207'
# ***************************************
...
while current_date <= end_date:
    ...
    command = f"python camping2.py --start-date {(start_date).strftime('%Y-%m-%d')}\
    --end-date {(end_date).strftime('%Y-%m-%d')} --show-campsite-info --parks " + park_string + "  > output.txt"
