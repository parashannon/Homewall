...
void setWhite(){
      ...
      for (int row_i = 1; row_i < 7; row_i = row_i + 1) {
      for (int column_i = 1; column_i < 12; column_i = column_i + 1) {
        setLightToColor(row_i, column_i, 0, 0, 0);
      }
    }
...
void setaRandomProblem() {
  ...
  int diff_per_level[11]={300, 300, 350, 471, 653,  940, 1650, 2600, 3500, 4300, 5200};
  ...
  max_row = 3 + ((diff_level*3) / 10);
  max_column = 4 + ((diff_level*3) / 10);
